...
export default function SpecialText({
  ...
  return (
    <div className="flex flex-col justify-center items-center md:items-start gap-4 w-full max-w-[500px] mx-auto md:max-w-none p-4">
      <SpecialHeadline {...HeadlineProps} />
      <hr className="px-4 w-full md:w-[90%] border-neutral-600 my-4" />
