...
export default function Premise() {
  return (
    <section className="bg-neutral-200 rounded-md mx-2 my-1 flex flex-col p-4 pb-8 md:mx-16 md:my-8 md:py-12 md:px-12 md:flex-row-reverse md:gap-8">
      ...
      <div className="text-neutral-700 w-full md:w-2/3">
        ...
        <p className="text-xs md:text-base lg:text-lg">After 171 years of consecutive readings, Dickens has reached a breaking point. Unbeknownst to the theater management, he will not be performing his show this evening. Tonight will be something entirely different. Something new. Something he is calling, in his head, &ldquo;Charles Dicken&apos;s First Annual Holiday Party.&rdquo;</p>
