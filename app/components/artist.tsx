...
export default function Artist() {
  return (
    <section className=" bg-neutral-900 flex border-x border-neutral-600">
      <div className=" bg-neutral-200 flex items-center justify-center">
        <div className="md:w-[80%] flex flex-col mx-2 my-1 rounded-md p-4 pb-8  md:my-2 md:py-12 md:flex-row-reverse md:gap-8 md:items-start">
