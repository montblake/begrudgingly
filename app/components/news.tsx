export default function News() {
  return (
    <div className="px-2 flex justify-center">
      ...
      < div className="bg-neutral-200 text-neutral-700 flex flex-col p-4 pt-4 pb-8 rounded-md md:mx-16 md:my-8 md:pt-12 md:pb-16 md:px-24  max-w-[1080px]" >
        <h2 className="text-lg md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 lg:mb-3" > The News</h2>
        <p className=" text-xs md:text-lg lg:text-xl mb-2 md:mb-3 lg:mb-4">After ten years, Blake Montgomery brings his Jeff Award-winning show back for the 2024 holiday season.</p>
        < p className=" text-xs md:text-lg lg:text-xl mb-2 md:mb-3 lg:mb-4" >Originally known as <span className="font-bold italic text-sm">
