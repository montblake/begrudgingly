  ...
  return (
    <section className="bg-neutral-900 p-2">
      ...
      <div className="w-full flex justify-center bg-neutral-200 rounded-md border border-neutral-600">
        ...
        < div className="
        text-neutral-700 flex flex-col p-4 pb-8 sm:p-16 sm:pt-12 md:p-24 md:pt-16 rounded-md
        landscape:w-[80%] landscape:px-0 landscape:my-8 landscape:pt-16 landscape:pb-24 landscape:flex-row landscape:gap-8
        lg:w-[80%] lg:px-0 lg:my-8 lg:pt-16 lg:pb-24 lg:flex-row lg:gap-8
        ">
