...
export default function History() {
  return (
    <section className="PAGETWO bg-neutral-200 flex flex-row-reverse justify-center items-center text-justify px-12 md:px-36 pt-8 pb-12" >
