  ...
  return (
    <section className="bg-neutral-900 md:border-x border-neutral-600" >
      <div className="bg-neutral-200  my-1 mx-2 rounded-md flex justify-center">
        <div className="w-3/4 flex flex-col md:flex-row items-center justify-center md:items-end md:gap-8 pt-4 pb-8  px-4  md:py-24 md:px-12 md:pb-36">
          <div className="w-full h-[320px] md:h-auto overflow-hidden rounded-lg pt-8 px-2 border border-neutral-700 mb-4 md:mb-0 md:w-1/3 md:border-none md:pt-0" >
            <Image
