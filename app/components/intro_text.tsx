export default function IntroText() {
  return (
    <div className="w-full h-auto">
      <p className="text-base sm:text-lg md:text-xl lg:text-2xl landscape:text-base">
      ...
      <p className="text-base sm:text-lg md:text-xl lg:text-2xl landscape:text-base mt-4">
