  ...
  return (
    <section className="bg-neutral-900 px-2">
      <div className="bg-neutral-200 my-1 rounded-md flex justify-center">
        ...
        >
          <div
            className=" w-full h-[420px] sm:h-[540px] md:h-[640px] overflow-hidden rounded-lg  border border-neutral-700 flex justify-end items-start 
          ...
          <div className="text-gray-700 w-full mt-4 md:mt-8 lg:w-2/3 lg:mt-0 lg:w-2/3 lg:mt-0">
            ...
            <div>
              <p className="text-sm sm:text-base md:text-lg mb-2 sm:mb-3 lg:text-lg lg:mb-4 lg:text-lg lg:mb-4">
                ...
                show this evening. Instead, he has planned something entirely
                new, something he is calling, &ldquo;Charles Dicken&apos;s First
                Annual Holiday Party.&rdquo;
              </p>
              <p className="text-sm sm:text-base md:text-lg mb-2 sm:mb-3 lg:text-lg lg:mb-4 lg:text-lg lg:mb-4">
                {" "}
              ...
              <p className="text-sm sm:text-base md:text-lg mb-2 sm:mb-3 lg:text-lg lg:mb-4 lg:text-lg lg:mb-4">
                ...
                which, due to some highly irregular and ridiculous occurrence,
                he might see his work in a new light, rediscovering its beauty
                and his passion while, along the way, forging the kind of
                intimate, joyful connection with the audience he had hoped would
                come from hosting a party in the first place. Perhaps.
              </p>
            </div>
          </div>
        </div>
