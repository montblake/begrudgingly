  ...
  return (
    <div className="py-8 px-12 relative flex flex-col justify-center items-center w-full bg-black landscape:px-24 lg:px-24">
      ...
      <div className="text-center text-md ">
        {showExplanation && (
          <p className="italic text-xs text-center text-amber-200">
            Specifically, comments from Goldstar members who attended the <br />
            2012 production at The Building Stage.
          </p>
        )}
      </div>
    </div>
