...
const photos = [
  {
    src: "/photos/brosilow/DSC_6384.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1266.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: false,
  },
  {
    src: "/photos/brosilow/DSC_6405.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: false,
  },
  {
    src: "/photos/brosilow/DSC_6395.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: false,
  },
  {
    src: "/photos/brosilow/MBP_0883.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1033.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_0739.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_0761.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1062.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_0863.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_0866.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_0897.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1010.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1056.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: false,
  },
  ...
  {
    src: "/photos/brosilow/MBP_1224.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: false,
  },
  {
    src: "/photos/brosilow/MBP_1259.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1229.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
  {
    src: "/photos/brosilow/MBP_1070.avif",
    alt: "Charles Dickens",
    credit: "Michael Brosilow",
    vertical: true,
  },
...
const textElement = (
  <div className="w-full flex flex-col items-center justify-center bg-neutral-800 rounded-2xl p-4">
    <p className="text-neutral-300 text-xs md:text-sm leading-relaxed">
      ...
      Den Theatre in Chicago. Photographed by Michael Brosilow during the live
      first preview performance, these images showcase Montgomery&apos;s
      portrayal of Charles Dickens in this one-man theatrical adaptation of the
      classic Christmas tale. Brosilow&apos;s unmatched skill at capturing the
      nuance and detail of a show in real-time is evident throughout these
      photographs, which capture the production&apos;s perfect balance of
      dramatic storytelling and playful humor, showcasing Montgomery&apos;s
      intimate, off-the-cuff performance style that makes the familiar story
      feel fresh and engaging. The CLOWNSHOW production ran from December 5-22,
      2024, and received critical acclaim from Chicago theater critics.
    </p>
  </div>
);
