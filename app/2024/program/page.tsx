        ...
        <div className="flex flex-col items-center justify-start gap-4 max-w-xl">
          <div className="flex flex-col items-center justify-start gap-1">
            ...
            <p className="text-base">
              ...
              Chicago Shakespeare, Steppenwolf, and Writers Theatre. Honoring
              the Past, Present, and Future: this performance is dedicated to
              Anne, Lauren, and Bodie.
            </p>
          </div>
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              <span className="font-bold">Izumi Inaba (Costume Design)</span> is
              so delighted to work with Blake again! Previously with him, she
              has designed{" "}
              <span className="italic">
                Charles Dickens Begrudgingly Performs ‘A Christmas Carol’ Again
              </span>{" "}
              and <span className="italic">Moby Dick</span> at Building Stage
              back in 2011. Her recent works include{" "}
              ...
              Theatre), and <span className="italic">The Comedians</span>{" "}
              (Ravens Theatre). Upcoming projects include{" "}
          ...
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              <span className="font-bold">Megan E. Pirtle (Wig Design)</span> is
              a Chicago based theatre artist specialized in wig, costume, and
              makeup design. Her designs for Haymarket include{" "}
              <span className="italic">
                La liberazione di Ruggiero dall&apos;isola d&apos;Alcina
              </span>
              , <span className="italic">Marc&apos;Antonio e Cleopatra</span>,{" "}
              <span className="italic">L&apos;incoronazione di Poppea</span>,
              and <span className="italic">L&apos;amant Anonyme</span>. Selected
              wig design credits include{" "}
              ...
              <span className="italic">Mesmerized</span> (Chicago
              Children&apos;s Theatre),{" "}
              <span className="italic">The October Storm</span>,{" "}
            ...
            <p className="text-base">
              She has also worked as the Wig & Hair Coordinator and Artisan for{" "}
              <span className="italic">Villette</span>,{" "}
              <span className="italic">Her Honor Jane Byrne</span>{" "}
              (Lookingglass), <span className="italic">Two Trains Running</span>{" "}
              (Court), <span className="italic">Ring of Fire</span> (Drury
              Lane), <span className="italic">Dial M for Murder</span> and{" "}
              <span className="italic">Georgiana & Kitty</span> (Northlight).
              ...
              cosmetologist of Illinois. And in 2023, she was the recipient of
              the Michael Merritt Emerging Technical Collaborator Award. For
              more, visit meganpirtledesign.com.
            </p>
          </div>
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              <span className="font-bold">Emmitt Socey (Lighting Design)</span>{" "}
              is a recent graduate of Loyola University Chicago and one of those
              multi-hyphenates people love to talk about. They work primarily as
              a director and lighting designer with recent credits including
              Guest Co-Director for{" "}
              <span className="italic">Orange Julius</span> for Loyola,
              Dramaturg and Director of new one-woman show{" "}
              ...
              Earlham College in Richmond, IN. They also had the joy of
              interning at Peninsula Players Theatre in Door County, WI, where
              they were the props intern for the summer. They would like to
              thank Lee Keenan specifically for supporting their growth and
              connecting them with this production.
            </p>
          </div>
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              ...
              Institute (&ldquo;Cherubs&rdquo;) program, and a alumni of
              Directors Lab North 2024. See more at oskarcywestbridge.com.
            </p>
          </div>
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              ...
              things. When it&apos;s not Christmas, he can be seen teaching at
              The Theatre School at DePaul University. He appears on stages in
              Chicago for the past 30 years and occasionally on your television
              or social media platform. George is the Theatre Arts Division
              Director of The National High School Institute at Northwestern
              University, more commonly known as the cherubs program. He plans
              to make theatre and music, and be around art, until he is
              inevitably compared to the Dickensian &ldquo;doornail.&rdquo;
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              <span className="font-bold">Andrew Snyder (House Manager)</span>{" "}
              is a Theatre Artist/Musician from Fort Smith, AR. Previous Chicago
              ...
              <span className="italic">Dying For It</span> with The Artistic
              Home. Andrew holds a B.A. in Acting/Directing from the University
              of Arkansas at Fort Smith and an M.F.A in Acting from Northern
              Illinois University.
            </p>
          </div>
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
              ...
              Theatre&apos;s 24-25 season and is the production assistant for
              Joe Mazza at brave lux inc. She recently worked on Writer&apos;s
              Theatre&apos;s <span className="italic">Great Comet</span> as the
              LX/A2 cover and will be sound designing at Citadel Theatre in the
              spring. She is an alum of Loyola University Chicago and is
              thrilled to be part of this production!
            </p>
          </div>
          <div className="flex flex-col items-center justify-start gap-1">
            <p className="text-base">
