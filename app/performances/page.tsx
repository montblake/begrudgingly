...
export default function Performances() {
  return (
    <main className="w-full min-h-screen relative z-50 text-gray-400 flex flex-col justify-between items-center bg-black mt-10">
      <Nav />

      <div className="max-w-screen-xl w-full flex-grow pt-12 px-4 sm:px-12 lg:px-16 pb-12 lg:pt-8">
