  ...
  return (
    <div className="flex flex-col justify-center items-center pb-8 w-full ">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center text-neutral-200 text-lg mb-4">
          <p className="">The Den Theatre</p>
          <p className="">1331 N. Milwaukee Ave.</p>
        </div>
        <p className="text-sm italic text-neutral-400">Box Office</p>
        <p className="text-lg">
          <a
            // href="tel:773-697-3830"
            className="hover:text-amber-300/80 text-neutral-200 transition-colors duration-300"
          >
            (773) 697-3830
          </a>
        </p>
