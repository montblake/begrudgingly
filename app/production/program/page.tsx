export default function Program() {
  return (
    <div className="w-full h-fit p-8">
      <div className="flex flex-col items-center justify-center max-w-2xl px-4 sm:px-12 md:px-16 w-full bg-neutral-100/70 text-neutral-900 py-8 sm:py-12 md:py-16 rounded-xl mx-auto">
