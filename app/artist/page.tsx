...
export default function Home() {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col justify-between items-start bg-victorian-texture bg-cover bg-center bg-no-repeat relative mx-auto mt-8 lg:mt-10">
      ...
      <div
        className="max-w-[1200px] mx-auto w-full h-full lg:h-fit flex flex-col lg:flex-row lg:justify-between lg:items-start gap-0 lg:overflow-scroll lg:px-16 lg:gap-8 pt-8 sm:pt-12 lg:pt-8 lg:pb-8 mix-blend-screen"
        ...
        <div className="w-full flex flex-col bg-black lg:w-1/2 max-w-[600px] mx-auto mt-8 lg:mt-0 mb-12 lg:mb-0">
          <div className="lg:mb-0 text-gray-400 px-4 sm:px-12 lg:px-0">
            ...
            {/* <h1 className="text-3xl text-center">
              &ldquo;An exceptional one-man performance that entertained
              thoroughly! Superbly crafted and performed.&rdquo;
            </h1> */}
            <h1 className="text-3xl text-center">
