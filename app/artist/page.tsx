...
export default function Home() {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col justify-start items-start bg-black relative mx-auto mt-10 sm:mt-12 landscape:mt-0">
      <Nav />

      <div
        className="w-full landscape:h-fit flex flex-col landscape:flex-row landscape:justify-between landscape:items-start gap-0 landscape:mt-12 landscape:overflow-scroll landscape:py-8 landscape:px-16 landscape:gap-16 pt-0 sm:pt-8"
