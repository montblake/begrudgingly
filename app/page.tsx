      ...
      <div className="w-full flex flex-col gap-8 justify-start items-center md:flex-row md:justify-center md:items-stretch md:gap-8 mx-auto p-4 md:p-8 w-full">
        <div className="w-full md:w-1/2 p-0 flex flex-col justify-start items-center gap-0">
          ...
          <div className="w-full flex flex-col gap-0 rounded-xl px-2 md:px-6 text-neutral-950">
            <div className="w-full rounded-xl md:px-6 md:py-0 border border-neutral-600 relative flex flex-col items-start justify-start overflow-hidden">
              <div className="bg-neutral-900/30 backdrop-blur w-full px-4 py-2">
              ...
              <div className="w-full bg-neutral-300 backdrop-blur relative z-30 flex flex-col items-center justify-center overflow-hidden h-full md:h-auto rounded-xl">
                <div className="absolute bottom-0 left-[50%] w-full h-full bg-[url('/dickens_illustration.png')] bg-contain bg-bottom-left bg-no-repeat z-1 mix-blend-multiply opacity-100"></div>
                <div className="w-full rounded-xl flex flex-col items-start justify-start gap-0 relative z-2 pl-4 md:pl-8 pt-6 pb-8">
                  <h2 className="text-lg md:text-xl font-bold text-center">
                    December 4&ndash;28
                  </h2>
                  <p className="text-sm italic font-bold text-center my-2">
                    at
                  </p>
              ...
              <div className="w-full bg-neutral-900/30 backdrop-blur relative z-30 flex flex-col items-center justify-center">
